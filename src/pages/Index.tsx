      ...
      <header className="fixed top-0 inset-x-0 z-50 border-b border-gold/10 bg-graphite-dark/80 backdrop-blur-md">
        <div className="container flex items-center justify-between h-20">
          <button onClick={() => scrollTo('hero')} className="flex items-center gap-3 group">
            <img src={LOGO} alt="Логотип" className="w-16 h-16 object-contain mix-blend-lighten group-hover:opacity-90 transition-all" />
      ...
      <footer className="py-12 border-t border-gold/10">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src={LOGO} alt="Логотип" className="w-14 h-14 object-contain mix-blend-lighten" />
